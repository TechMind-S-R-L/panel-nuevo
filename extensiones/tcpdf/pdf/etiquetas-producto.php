...
$producto = $idProducto > 0 ? ModeloInventario::mdlDatosEtiquetasProducto($idProducto) : null;
if (!$producto) {
...
$pdf->SetTitle("Etiquetas ".$producto["codigo"]);
...
foreach ($codigos as $indice => $item) {
...
ob_end_clean();
$pdf->Output("etiquetas-".$producto["codigo"].".pdf", "I");
