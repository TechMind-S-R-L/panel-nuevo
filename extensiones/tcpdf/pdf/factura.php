...
function RotatedTextNotaVenta($pdf, $x, $y, $txt, $angle) {
	$pdf->StartTransform();
...
$pdf->SetAlpha(0.1);
RotatedTextNotaVenta($pdf, 35, 180, 'NOTA DE VENTA', 45);
...
$pdf->SetFont('helvetica', 'B', 14);
$pdf->SetTextColor(70, 130, 180);
$pdf->Cell(60, 7, 'NOTA DE VENTA', 0, 1, 'R');
...
<table style="font-size:10px;" cellspacing="0" cellpadding="4" border="1">
  ...
  <tr>
    ...
    <td style="border:1px solid #000; width:180px;">Fecha entrega: <b>{$venta["fecha_despacho"]}</b></td>
  </tr>
</table>
EOF;
